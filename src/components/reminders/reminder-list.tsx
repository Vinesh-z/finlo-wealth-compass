...
export function ReminderList({ reminders, onToggleComplete }: ReminderListProps) {
  ...
  const sortedAndFilteredReminders = [...reminders]
      ...
      <CardContent>
        <div className="space-y-6">
          {Object.keys(groupedReminders).length > 0 ? (
            Object.entries(groupedReminders).map(([dateKey, dayReminders]) => (
              <div key={dateKey}>
                  ...
                  {dayReminders.map((reminder) => {
                    ...
                    return (
                      <Card key={reminder.id} className={cn(
                        ...
                        overdueReminder ? "border-red-500" : reminder.isCompleted ? "bg-muted" : ""
                      )}>
                        <div className="p-4">
                            ...
                            <div className="flex-1">
                              <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  {overdueReminder && (
                                    <Badge variant="destructive" className="text-[0.625rem] py-0 px-1.5">Overdue</Badge>
                                  )}
                                </div>
                              </div>
